...
2. Run the Python app.py:
   ...
   ~pipenv install: installation of the python virtual environment
   ~pipenv shell: Initialisation of the virtual environment
   ~python app.py: Executing the python file to start
